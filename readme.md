...
I chose these specific tools because they work well together for a fast, modern app:
    ...
    - Database: SQLite. I used this because it's a "file-based" database—perfect for a project like this where you want reliability without the overhead of a massive server.
